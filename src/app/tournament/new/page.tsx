...
function TournamentBuilder() {
  ...
  const [entrants, setEntrants] = useState<OpenRouterModel[]>([]);
  ...
  const ready = topic.trim().length >= 2 && entrants.length === size && !!judge;
